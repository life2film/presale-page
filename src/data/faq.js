export default [
    ...
    {
        text: 'Why are you running pre-ICO?',
        popup: 'We need to cover marketing, PR, development, security audit and other costs for the main ICO crowdfunding. Also, we will pay advisers for the consulting and code audit using the funds from presale.'
    },
    {
